	...
	public AccessViewProxy(TiViewProxy proxy) {
		...
		loginBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				loginEnabled(false);
				((AccessServiceProxy) getProxy()).login(loginSuccessCallback, loginErrorCallback, username.getText()
		...
		logoutBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				logoutEnabled(false);
				((AccessServiceProxy) getProxy()).logout(logoutSuccessCallback, logoutErrorCallback);
			}
		});
