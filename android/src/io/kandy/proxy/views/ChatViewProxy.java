...
public class ChatViewProxy extends TiUIView implements OnItemClickListener, OnActivityResultEvent,
	...
	public ChatViewProxy(TiViewProxy proxy) {
		...
		mInputMethodManager = (InputMethodManager) proxy.getActivity().getSystemService(Context.INPUT_METHOD_SERVICE);
		...
		mAdapter = new MessagesAdapter(proxy.getActivity(), KandyUtils.getLayout("message_listview_item"),
